...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen p-4 sm:p-6 pt-[max(1rem,env(safe-area-inset-top))] bg-gradient-to-b from-orange-50/40 via-rose-50/30 to-violet-50/40">
      ...
      {bgPickerOpen && <BackgroundPicker onClose={() => setBgPickerOpen(false)} />}
                  ...
                  <div className="absolute left-0 top-16 z-20 w-48 rounded-2xl border border-gray-100 bg-white py-1.5 shadow-lg">
                    ...
                    >
                      <svg className="w-4 h-4 text-violet-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M4 15l4-4a2 2 0 012.8 0L15 15m-2-2l1.5-1.5a2 2 0 012.8 0L20 13M9 9h.01" />
                      </svg>
                      Hintergrund
                    </button>
                    {user.avatar && (
